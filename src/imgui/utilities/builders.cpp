...
namespace ne_util = ax::NodeEditor::Utilities;

ne_util::BlueprintNodeBuilder::BlueprintNodeBuilder(ImTextureID texture, int textureWidth, int textureHeight):
...
void ne_util::BlueprintNodeBuilder::Begin(ed::NodeId id)
{
    HasHeader  = false;
...
void ne_util::BlueprintNodeBuilder::End()
{
    SetStage(Stage::End);
...
void ne_util::BlueprintNodeBuilder::Header(const ImVec4& color)
{
    HeaderColor = ImColor(color);
    SetStage(Stage::Header);
}

void ne_util::BlueprintNodeBuilder::EndHeader()
{
    SetStage(Stage::Content);
}

void ne_util::BlueprintNodeBuilder::Input(ed::PinId id)
{
...
void ne_util::BlueprintNodeBuilder::EndInput()
{
    ImGui::EndHorizontal();
...
void ne_util::BlueprintNodeBuilder::Middle()
{
    if (CurrentStage == Stage::Begin)
        SetStage(Stage::Content);
...
void ne_util::BlueprintNodeBuilder::Output(ed::PinId id)
{
    if (CurrentStage == Stage::Begin)
        SetStage(Stage::Content);
...
void ne_util::BlueprintNodeBuilder::EndOutput()
{
    ImGui::EndHorizontal();
...
bool ne_util::BlueprintNodeBuilder::SetStage(Stage stage)
{
...
void ne_util::BlueprintNodeBuilder::Pin(ed::PinId id, ed::PinKind kind)
{
    ed::BeginPin(id, kind);
}

void ne_util::BlueprintNodeBuilder::EndPin()
{
    ed::EndPin();
